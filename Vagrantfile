...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'compute' do |compute|
    compute.vm.box = "boxcutter/centos71"
    compute.vm.network "private_network", ip: "172.16.0.20"
  ...
  config.vm.define 'packstack' do |packstack|
    packstack.vm.box = "boxcutter/centos71"
    packstack.vm.network "private_network", ip: '172.16.0.10'
    packstack.vm.network "forwarded_port", guest: 22, host: 2244
    packstack.vm.provider :virtualbox do |vb|
      vb.memory = '768'
    end
